                ...
                function doitx(param) {
                    ...
                    */
                    ...
                    function dotransaction() {
                        ...
                        var eos_memo = "function set_circle_element(elm, value) {
                    value = value.toFixed(0);
                    if (value > 100) value = 100;
                        ...
                        eosobject.getTableRows({
                            ...
                            try {
                                ...
                                document.getElementById('dotransaction_bundle').style.visibility = "visible";
                                    ...
                                    document.getElementById('powMiningRate').innerHTML = "<span class='bold' style='font-size:14px;'>Mining Reward per Transaction: <span style='color:#00bb00'>" + mining_rate + "</span> POW</span>";
